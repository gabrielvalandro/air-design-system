/* http://prismjs.com/download.html?themes=prism-solarizedlight&languages=markup+css+clike+javascript&plugins=toolbar+copy-to-clipboard */
...
(function(){
	...
	Prism.plugins.toolbar.registerButton('copy-to-clipboard', function (env) {
		...
		linkCopy.classList.add('tooltipped', 'tooltipped-w', 'tooltipped-no-delay');
		linkCopy.setAttribute('aria-label', 'Copy');

		var icon = document.createElement('i');
		icon.classList.add('fa', 'fa-clone');

		linkCopy.appendChild(icon);
